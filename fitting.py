...
def run_fitting():
    ...
    plt.axhline(y=initial_loss_estimate, color='r', linestyle='--')
    plt.axhline(y=fitted_asymptote, color='r', linestyle='--')
    linspace_time_overshoot = np.arange(2, fitting_time_skip+1, 1)
...
if __name__ == "__main__":
    ...
    print("Specific Heat: "+str(round_sig(conductivity/(diffusivity*cell_mass_density),4))+" m^2/s")
    # print("Conductivity stderr: "+str(conductivity_error)+" W/(m*K)")
    # print("Diffusivity stderr: "+str(diffusivity_error)+" m^2/s")