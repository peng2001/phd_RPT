...
heatflux_file = 'data/Sabines Rig J1PA/75soc/J1PA_throughplane_75soc_25-30_sabine.csv'
...
# plt.plot(HeatfluxData['time_elapsed'], HeatfluxData["average_heatflux"], label="Average")
